...
void Keyboard::RenderKeyboard(bool is_upper_case){
	for(int i=0; i<5; i++){
...
char Keyboard::GetKey(uint16_t x, uint16_t y){
	uint8_t i = (y-oy)/kh;
...
char Keyboard::ToUpperCase(const char& c){
